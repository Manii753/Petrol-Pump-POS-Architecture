...
export default function Layout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Sales', href: '/sales', icon: 'M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z' },
    { name: 'Pumps', href: '/pumps', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { name: 'Tanks', href: '/tanks', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-secondary-200">
          <div className="flex items-center">
            ...
            <h1 className="ml-3 text-lg font-semibold text-secondary-900">Petrol POS</h1>
          </div>
          <button
          ...
          <div className="space-y-1">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-secondary-700 hover:text-secondary-900 hover:bg-secondary-100 transition-colors duration-200"
              >
                <svg className="mr-3 h-5 w-5 text-secondary-400 group-hover:text-secondary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="lg:pl-64">
        ...
        <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
          <button
            ...
            className="px-4 border-r border-secondary-200 text-secondary-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 lg:hidden"
          >
